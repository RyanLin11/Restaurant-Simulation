...
public class Timer extends Actor
{
    ...
    public Timer()
    {
        ...
        outlineColor = new Color(25, 40, 65); 
        textColor = new Color(139, 0, 139);
        updateImage();
    }
    ...
    private void updateImage()
    {
        ...
        text = new GreenfootImage(String.valueOf(df.format((double)milliSeconds/1000)), this.textSize,this.textColor, null);
